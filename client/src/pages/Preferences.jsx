    ...
    return (
        <div className="page">
            ...
            <div className="profile-card">
                ...
                <button onClick={savePreference} disabled={!favoriteTeam || !favoriteDriver}>
                    Save Preferences
                </button>
            </div>

            <div className="info-card" style={{ maxWidth: 480, margin: "20px auto 0" }}>
                <h3>How Personalization Works</h3>
                <p>
                    Save your favorite team and driver to receive a personalized
